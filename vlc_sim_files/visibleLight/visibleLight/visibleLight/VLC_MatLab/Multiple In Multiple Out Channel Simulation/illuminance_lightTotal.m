...
function [Zprx,X,Y,Z,impulse_response_tF,impulse_response_fF,impulse_response_diffF,impulse_response_dF] = illuminance_lightTotal(irradiance,incidence,LED_VA,PD_FOV,t,HTotal)
...
% impulse_response_t = conv(prx4,timefunction)*0.01;
% impulse_response_diff = conv((prx4-PRXLOS4),diffusedtimefunction)*0.01;
% impulse_response_f = PRXLOS4.*frequencyfunction;
% impulse_response_d = (prx4-PRXLOS4).*diffusedfreqfunction;

impulse_response_tF = conv(prx,timefunction)*0.01;
impulse_response_diffF = conv((prx-PRXLOS),diffusedtimefunction)*0.01;
impulse_response_fF = PRXLOS.*frequencyfunction;
impulse_response_dF = (prx-PRXLOS).*diffusedfreqfunction;
